...
#define DMA_RX_IRPT_INTR XPAR_INTC_0_MPMC_0_SDMA2_RX_INTOUT_VEC_ID
#define DMA_TX_IRPT_INTR XPAR_INTC_0_MPMC_0_SDMA2_TX_INTOUT_VEC_ID
#endif


#define RXBD_CNT        2	/* Number of RxBDs to use */
#define TXBD_CNT        2	/* Number of TxBDs to use */
#define BD_ALIGNMENT    XLLDMA_BD_MINIMUM_ALIGNMENT	/* Byte alignment of BDs */

#define CSUM_ENABLE     0
/*
 ...
 * Utility routines
 */
static __inline__ int TemacResetDevice(XLlTemac * TemacInstancePtr,
			    XLlDma * DmaInstancePtr);
