...
#define CYGPKG_KERNEL_INSTRUMENT 1
#define CYGNUM_KERNEL_INSTRUMENT_BUFFER_SIZE 256
#define CYGNUM_KERNEL_INSTRUMENT_BUFFER_SIZE_256
#define CYGDBG_KERNEL_INSTRUMENT_BUFFER_WRAP 1
#define CYGDBG_KERNEL_INSTRUMENT_FLAGS 1
#define CYGDBG_KERNEL_INSTRUMENT_SCHED 1
#define CYGDBG_KERNEL_INSTRUMENT_THREAD 1
#define CYGDBG_KERNEL_INSTRUMENT_INTR 1
#define CYGDBG_KERNEL_INSTRUMENT_MUTEX 1
#define CYGDBG_KERNEL_INSTRUMENT_CONDVAR 1
#define CYGDBG_KERNEL_INSTRUMENT_BINSEM 1
#define CYGDBG_KERNEL_INSTRUMENT_CNTSEM 1
#define CYGDBG_KERNEL_INSTRUMENT_MBOXT 1
#define CYGDBG_KERNEL_INSTRUMENT_CLOCK 1
#define CYGDBG_KERNEL_INSTRUMENT_ALARM 1
#define CYGDBG_KERNEL_INSTRUMENT_SMP 1
#define CYGDBG_KERNEL_INSTRUMENT_USER 1
#define CYGDBG_KERNEL_INSTRUMENT_MSGS 1
